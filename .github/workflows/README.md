...
- Test lanes enable hang diagnostics for long-running .NET tests and upload uniquely named evidence artifacts for reruns so passing and failing runs both leave inspectable logs.
