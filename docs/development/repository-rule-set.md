...
- Use pipeline/channel abstractions approved by ADRs for producer-consumer flows (see [Async streaming policy ADR](../adr/004-async-streaming-patterns.md) and [Bounded channel policy ADR](../adr/013-bounded-channel-policy.md)).
