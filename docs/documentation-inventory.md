...
| `archive/docs/developer/` | source-material | `docs/engineering/` | Merged legacy setup/build guidance migration. |
...
| `docs/ui/` | archive | `archive/docs/ui/` | Archived during migration. Keep a short stub in `docs/ui/` with replacement links. |
...
| 2026-05-31 | `docs/status/broker-phase-promotion-checklist-template.md`, `docs/status/dead-code-inventory.md`, `docs/status/ibkr-provider-inventory.md`, `docs/status/provider-adapters-closure-summary.md`, `docs/status/provider-capability-inventory.md`, `docs/status/provider-core-hardening-notes.md`, `docs/status/provider-failover-hardening.md`, `docs/status/provider-test-gap-baseline.md`, `docs/status/provider-test-minimums.md` | `archive/docs/summaries/broker-phase-promotion-checklist-template.md`, `archive/docs/summaries/dead-code-inventory.md`, `archive/docs/summaries/ibkr-provider-inventory.md`, `archive/docs/summaries/provider-adapters-closure-summary.md`, `archive/docs/summaries/provider-capability-inventory.md`, `archive/docs/summaries/provider-core-hardening-notes.md`, `archive/docs/summaries/provider-failover-hardening.md`, `archive/docs/summaries/provider-test-gap-baseline.md`, `archive/docs/summaries/provider-test-minimums.md` | Status snapshots demoted to archive migration stubs; active status index retained in canonical roadmap/product ownership lanes. |
| 2026-05-31 | `docs/design/README.md`, `docs/design/design-system-usage.md` | `archive/docs/design/README.md`, `archive/docs/design/design-system-usage.md` | Design-folder migration completed: archived design-system usage notes; active `docs/design/README.md` now points to archive and canonical owners. |
| 2026-05-31 | `docs/ui/README.md`, `docs/ui/components.md` | `archive/docs/ui/README.md`, `archive/docs/ui/components.md` | UI-folder migration completed: archived workstation UI component guidance and replaced active path with migration stub plus canonical replacement pointers. |
| 2026-05-31 | `docs/design/README.md`, `docs/design/design-system-usage.md` | `archive/docs/design/README.md`, `archive/docs/design/design-system-usage.md` | Design-folder migration completed: archived design-system usage notes; active `docs/design/README.md` now points to archive and canonical owners. |
...
| 2026-05-31 | `docs/status/broker-phase-promotion-checklist-template.md`, `docs/status/` + related hand-authored status snapshots now stubbing to `archive/docs/summaries/*` | Same-named files in `archive/docs/summaries/` plus on-path stubs | Completed a second status migration batch to demote non-generated status and planning snapshots (including roadmap/provider/status matrices) while preserving generated report ownership. |
...
| 2026-05-31 | `docs/providers/data-sources.md`, `docs/providers/provider-confidence-baseline.md`, `docs/providers/stocksharp-connectors.md`, `docs/providers/tradestation-endpoint-inventory.md`, `docs/providers/broker-adapter-template-guide.md` | `archive/docs/providers/*` | Legacy provider catalog and planning pages now redirect to active operator/reference lanes; active high-traffic pointers now stay in canonical provider reference and operators docs. |
