...
| Provider capability and readiness lookup | [Provider Capability Matrix](../status/provider-capability-matrix.md), [Provider Validation Matrix](../status/provider-validation-matrix.md), [Provider Comparison](../providers/provider-comparison.md) | Migration inputs until stable provider lookup material is consolidated here. |
| Contract compatibility and schemas | [Contract Compatibility Matrix](../status/contract-compatibility-matrix.md), [Provider Validation Evidence Schema](../status/provider-validation-evidence-schema.md), [Workstation Cockpit Acceptance Matrix](../status/workstation-cockpit-acceptance-matrix.md) | Keep generated or matrix-owned content in place until moved through a focused migration. |
| UFL and asset profiles | [UFL Supported Assets Index](../plans/ufl-supported-assets-index.md), [UFL Capability Model](../plans/ufl-capability-model.md), [UFL Conformance Matrix](../plans/ufl-conformance-matrix.md) | Target-state lookup material should migrate from `docs/plans/` into reference when stable. |
