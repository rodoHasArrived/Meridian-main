...
| Legacy fund rows missing tenant attribution | [Fund Structure Tenant Backfill](./fund-structure-tenant-backfill.md) | reviewed preview/apply, exception queue, atomic receipts, and strict-read readiness |
