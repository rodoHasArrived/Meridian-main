...
| `SRC-BACKTESTING` | Meridian backtesting | `W5-BTSTUDIO-001` | Backtesting studio evidence loop |
| `SRC-BACKTESTING-SDK` | Backtesting SDK | `W5-BTSTUDIO-001` | Backtesting studio evidence loop |
...
| `SRC-CORE` | Meridian core | `W6-LIVE-001` | Live-readiness governance |
...
| `SRC-EXECUTION` | Meridian execution | `W6-LIVE-001` | Live-readiness governance |
| `SRC-EXECUTION-SDK` | Execution SDK | `W2-TRD-001` | Paper trading cockpit reliability |
| `SRC-EXECUTION-SDK` | Execution SDK | `W6-LIVE-001` | Live-readiness governance |
| `SRC-FSHARP` | Meridian FSharp | `W3-CONT-001` | Research to paper continuity |
| `SRC-FSHARP` | Meridian FSharp | `W5-BTSTUDIO-001` | Backtesting studio evidence loop |
...
| `SRC-HOST` | Meridian host | `W6-LIVE-001` | Live-readiness governance |
...
| `SRC-QUANTSCRIPT` | QuantScript | `W5-BTSTUDIO-001` | Backtesting studio evidence loop |
| `SRC-RISK` | Meridian risk | `W2-TRD-001` | Paper trading cockpit reliability |
| `SRC-RISK` | Meridian risk | `W6-LIVE-001` | Live-readiness governance |
...
| `SRC-STRATEGIES` | Meridian strategies | `W5-BTSTUDIO-001` | Backtesting studio evidence loop |
