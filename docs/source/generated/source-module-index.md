...
| `SRC-BACKTESTING` | Meridian backtesting | `src/Meridian.Backtesting` | Backtesting | active | Strategy and Research | `src/Meridian.Backtesting/README.md` |
| `SRC-BACKTESTING-SDK` | Backtesting SDK | `src/Meridian.Backtesting.Sdk` | Backtesting SDK | active | Strategy and Research | `src/Meridian.Backtesting.Sdk/README.md` |
