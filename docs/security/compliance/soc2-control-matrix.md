...
| CC8 (Change Management) | CI/CD and release automation include repeatable build/test workflows, diagnostics, and artifact traceability. | DevEx Lead | `docs/engineering/README.md`; `docs/operators/deployment-packaging.md`; `.github/workflows/production-certification.yml` (dependency-evidence, deterministic integrations, recovery drill, documentation evidence); `.github/workflows/codeql.yml`; `.github/workflows/desktop-installer-packaging.yml` (release artifact traceability) |
