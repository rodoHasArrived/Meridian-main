# Archived Legacy Plan: ufl-certificate-of-deposit-target-state-v2

This plan has been migrated to [ufl-certificate-of-deposit-target-state-v2.md](../../archive/docs/plans/ufl-certificate-of-deposit-target-state-v2.md).
