# Archived Legacy Plan: ufl-cash-sweep-target-state-v2

This plan has been migrated to [ufl-cash-sweep-target-state-v2.md](../../archive/docs/plans/ufl-cash-sweep-target-state-v2.md).
