# Archived Legacy Plan: ufl-projection-and-evidence-kernel

This plan has been migrated to [ufl-projection-and-evidence-kernel.md](../../archive/docs/plans/ufl-projection-and-evidence-kernel.md).
