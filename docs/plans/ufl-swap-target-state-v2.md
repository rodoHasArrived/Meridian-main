# Archived Legacy Plan: ufl-swap-target-state-v2

This plan has been migrated to [ufl-swap-target-state-v2.md](../../archive/docs/plans/ufl-swap-target-state-v2.md).
