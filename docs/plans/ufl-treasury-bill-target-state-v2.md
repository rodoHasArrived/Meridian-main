# Archived Legacy Plan: ufl-treasury-bill-target-state-v2

This plan has been migrated to [ufl-treasury-bill-target-state-v2.md](../../archive/docs/plans/ufl-treasury-bill-target-state-v2.md).
