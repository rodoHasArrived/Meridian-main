# Archived Legacy Plan: ufl-warrant-target-state-v2

This plan has been migrated to [ufl-warrant-target-state-v2.md](../../archive/docs/plans/ufl-warrant-target-state-v2.md).
