# Archived Legacy Plan: ufl-bond-target-state-v2

This plan has been migrated to [ufl-bond-target-state-v2.md](../../archive/docs/plans/ufl-bond-target-state-v2.md).
