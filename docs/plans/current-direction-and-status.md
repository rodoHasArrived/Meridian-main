# Archived Legacy Plan: current-direction-and-status

This plan has been migrated to [current-direction-and-status.md](../../archive/docs/plans/current-direction-and-status.md).
