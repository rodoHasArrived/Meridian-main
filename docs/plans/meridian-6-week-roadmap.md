...
- treat System Health triage as support-triage evidence only when it summarizes provider, storage, and retained event posture without substituting for readiness gates, provider validation, or durable incident queues
