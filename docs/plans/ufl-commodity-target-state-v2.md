# Archived Legacy Plan: ufl-commodity-target-state-v2

This plan has been migrated to [ufl-commodity-target-state-v2.md](../../archive/docs/plans/ufl-commodity-target-state-v2.md).
