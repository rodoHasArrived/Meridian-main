# Archived Legacy Plan: ufl-fx-spot-target-state-v2

This plan has been migrated to [ufl-fx-spot-target-state-v2.md](../../archive/docs/plans/ufl-fx-spot-target-state-v2.md).
