# Archived Legacy Plan: ufl-deposit-target-state-v2

This plan has been migrated to [ufl-deposit-target-state-v2.md](../../archive/docs/plans/ufl-deposit-target-state-v2.md).
