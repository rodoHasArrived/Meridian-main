# Archived Legacy Plan: ufl-direct-lending-implementation-roadmap

This plan has been migrated to [ufl-direct-lending-implementation-roadmap.md](../../archive/docs/plans/ufl-direct-lending-implementation-roadmap.md).
