...
- [x] Define scope boundaries for **paper trading cockpit reliability sprint** and document explicit in-scope vs out-of-scope items.
...
- [x] Add/update operator runbook steps and rollback procedure for the paper trading cockpit reliability sprint workflow.
