# Archived Legacy Plan: ufl-direct-lending-target-state-v2

This plan has been migrated to [ufl-direct-lending-target-state-v2.md](../../archive/docs/plans/ufl-direct-lending-target-state-v2.md).
