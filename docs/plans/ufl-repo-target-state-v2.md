# Archived Legacy Plan: ufl-repo-target-state-v2

This plan has been migrated to [ufl-repo-target-state-v2.md](../../archive/docs/plans/ufl-repo-target-state-v2.md).
