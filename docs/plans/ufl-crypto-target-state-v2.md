# Archived Legacy Plan: ufl-crypto-target-state-v2

This plan has been migrated to [ufl-crypto-target-state-v2.md](../../archive/docs/plans/ufl-crypto-target-state-v2.md).
