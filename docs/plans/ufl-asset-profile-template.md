# Archived Legacy Plan: ufl-asset-profile-template

This plan has been migrated to [ufl-asset-profile-template.md](../../archive/docs/plans/ufl-asset-profile-template.md).
