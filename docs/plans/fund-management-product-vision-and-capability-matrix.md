...
| Workspace shell (`Research`, `Trading`, `Data Operations`, `Governance`) | Cross-cutting platform | Implemented baseline | Phase 1 | WPF shell/navigation baseline, context strips, command/search metadata, and Trading/Research desk briefing heroes are present; workflow acceptance remains active Wave 2-4 work |
...
| Order, execution, and trade management | Front office / Middle office | In progress | Phase 2 | Paper-session, replay, audit, promotion, DK1 trust-gate, and readiness contracts are in code; dependable daily-use acceptance remains Wave 2 work |
...
- WPF exposes a four-workspace shell baseline, run/portfolio/ledger/cash-flow drill-ins, Governance/Fund Ops routes, Security Master workflows, and Trading/Research briefing surfaces
...
3. Keep WPF Trading and Research briefing surfaces as consumers of shared readiness/run contracts, not separate acceptance models.
