# Archived Legacy Plan: fund-management-product-vision-and-capability-matrix

This plan has been migrated to [fund-management-product-vision-and-capability-matrix.md](../../archive/docs/plans/fund-management-product-vision-and-capability-matrix.md).
