...
| Account and entity management | Middle office / Back office | In progress | Phase 2 | Fund-structure graph, assignment, account, entity, sleeve, vehicle, and environment-design seams exist; Fund Accounts now projects account-queue, provider-routing, shared-data, balance-evidence, and reconciliation-readiness states; richer operator review and durable casework flows remain open |
