# Archived Legacy Plan: ufl-other-security-target-state-v2

This plan has been migrated to [ufl-other-security-target-state-v2.md](../../archive/docs/plans/ufl-other-security-target-state-v2.md).
