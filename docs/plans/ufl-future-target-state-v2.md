# Archived Legacy Plan: ufl-future-target-state-v2

This plan has been migrated to [ufl-future-target-state-v2.md](../../archive/docs/plans/ufl-future-target-state-v2.md).
