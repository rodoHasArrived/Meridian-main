...
| Validation | `make ai-mdif-context` after source changes; `make ai-mdif-context-check`; `python3 build/scripts/docs/validate-docs-structure.py --top-level domain --summary`; `python3 build/scripts/docs/check-ai-inventory.py --summary`; `git diff --check -- <paths>` |
