...
| AI system inventory update | `docs/ai/ai-systems-inventory.md` | `python build/scripts/docs/check-ai-inventory.py --summary`; `python build/scripts/docs/check-ai-handoff.py --strict` only if manifest/handoff guidance changed |
