...
**Status:** active
**Owner:** core-team
**Reviewed:** 2026-08-27 (scheduled institutional-requirements pass; resolution pass 2026-08-26; scheduled institutional-requirements pass 2026-08-26; independent verification pass, post-resolution 2026-08-24; resolution pass 2026-08-24; verification pass 2026-08-14; original review 2026-08-12)
**Scope:** Engineering
...
The 2026-08-27 pass re-read the F# `SecurityKind` / `AssetClassRegistry` domain, the
`Meridian.Contracts` Security Master catalogs and terms schema, the Application-layer validation,
conflict-detection, workbench-command and rebuild services, `PostgresSecurityMasterStore` and the 29
migrations, the `Meridian.Instruments` projection services and
`InstrumentProjectionServiceBase`, `Meridian.Execution.TaxLotAccounting`, the browser workstation
passport surfaces, and the `tests/Meridian.Tests/SecurityMaster/` parity and coverage guards.
