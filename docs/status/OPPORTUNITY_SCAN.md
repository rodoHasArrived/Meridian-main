# Archived Legacy Status Item: OPPORTUNITY_SCAN

This status file has been migrated to [OPPORTUNITY_SCAN.md](../../archive/docs/status/OPPORTUNITY_SCAN.md). Active status and planning context should be read from canonical owners:
