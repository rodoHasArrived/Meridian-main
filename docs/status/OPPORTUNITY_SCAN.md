...
| 5 | Operator Readiness Console | High | Partial browser support evidence through the read-only `/trading/readiness` console, shared workstation readiness payloads, workflow command-palette commands, and Data market-context routes for live quotes, order book, recent-trade detail, watchlists, and historical charts | Wave 2 support surface |
...
| 10 | Buyer Demo Mode | Makes the browser dashboard commercially demonstrable with seeded funds, accounts, strategies, paper sessions, breaks, approvals, and report packs | Partial support through the demo-data banner, sample-flow links, and seeded AAPL market-data fixtures; buyer demo packs and role-based views remain open | Web dashboard support track |
