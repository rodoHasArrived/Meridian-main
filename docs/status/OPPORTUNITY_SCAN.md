...
| 10 | Buyer Demo Mode | Makes the browser dashboard commercially demonstrable with seeded funds, accounts, strategies, paper sessions, breaks, approvals, and report packs | Partial support through the demo-data banner, sample-flow links, Overview Today panel, Price Alerts, Strategy Designer, and seeded AAPL market-data fixtures; buyer demo packs and role-based views remain open | Web dashboard support track |
