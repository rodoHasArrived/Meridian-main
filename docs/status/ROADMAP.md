...
As of 2026-05-13, the browser lane adds a Today panel for day P&L, movers, open orders, and fills; local Price Alerts with trigger history and UTC poll/trigger timing; a visual Strategy Designer for multi-leg payoff and participation review; full-console readiness checkpoint gates; and Meridian Design System reference workbench/tokenized-color support. These items strengthen demo, readiness-review, and visual-contract evidence for the web lane. They do not close cockpit acceptance, durable reconciliation casework, report-pack lifecycle acceptance, Evidence Vault, report-line provenance, or controlled live-readiness.
