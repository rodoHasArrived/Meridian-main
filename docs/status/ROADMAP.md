...
**Repository Snapshot (2026-04-26 working tree):** solution/build/test project files: 39 | `src/` project files: 27 | test projects: 9 | workflow files: 42
