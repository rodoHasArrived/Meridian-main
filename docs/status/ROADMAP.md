...
**Repository Snapshot (2026-05-07 current repo):** solution/build/test project files: 40 | `src/` project files: 27 | test projects: 9 | workflow files: 44
