...
- treat the retained WPF Data shell and Provider Health posture briefing as support evidence only when they keep provider, backfill, storage, session, and export handoffs tied to shared operational services rather than duplicating readiness logic
