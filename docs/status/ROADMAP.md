...
**Repository Snapshot (2026-05-09 current repo):** solution/build/test project files: 43 | `src/` project files: 27 | test projects: 9 | workflow files: 44
