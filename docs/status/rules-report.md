...
*Generated: 2026-09-23 20:33:54 UTC*
...
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | ADR has context section | warning |
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | ADR has date | warning |
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | ADR has decision section | warning |
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | ADR has status field | error |
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | No hardcoded API keys in docs | error |
| `docs\adr\019-production-support-matrix-and-deployment-posture.md` | No hardcoded localhost URLs in docs | info |
| `docs\adr\020-lifecycle-control-plane.md` | ADR has context section | warning |
| `docs\adr\020-lifecycle-control-plane.md` | ADR has date | warning |
| `docs\adr\020-lifecycle-control-plane.md` | ADR has decision section | warning |
| `docs\adr\020-lifecycle-control-plane.md` | ADR has status field | error |
| `docs\adr\020-lifecycle-control-plane.md` | No hardcoded API keys in docs | error |
| `docs\adr\020-lifecycle-control-plane.md` | No hardcoded localhost URLs in docs | info |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | ADR has context section | warning |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | ADR has date | warning |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | ADR has decision section | warning |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | ADR has status field | error |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | No hardcoded API keys in docs | error |
| `docs\adr\021-verified-operation-outcomes-and-case-history.md` | No hardcoded localhost URLs in docs | info |
| `docs\adr\022-canonical-asset-class-homes.md` | ADR has context section | warning |
| `docs\adr\022-canonical-asset-class-homes.md` | ADR has date | warning |
| `docs\adr\022-canonical-asset-class-homes.md` | ADR has decision section | warning |
| `docs\adr\022-canonical-asset-class-homes.md` | ADR has status field | error |
| `docs\adr\022-canonical-asset-class-homes.md` | No hardcoded API keys in docs | error |
| `docs\adr\022-canonical-asset-class-homes.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\ai\ai-systems-inventory.md` | No hardcoded API keys in docs | error |
| `docs\ai\ai-systems-inventory.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\ai\tooling\README.md` | No hardcoded API keys in docs | error |
| `docs\ai\tooling\README.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\architecture\reporting-workstation-model.md` | No hardcoded API keys in docs | error |
| `docs\architecture\reporting-workstation-model.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\architecture\security-lot-convergence-blueprint.md` | No hardcoded API keys in docs | error |
| `docs\architecture\security-lot-convergence-blueprint.md` | No hardcoded localhost URLs in docs | info |
| `docs\architecture\security-master-extensibility-review.md` | No hardcoded API keys in docs | error |
| `docs\architecture\security-master-extensibility-review.md` | No hardcoded localhost URLs in docs | info |
| `docs\architecture\security-master-identifier-conflict-detection.md` | No hardcoded API keys in docs | error |
| `docs\architecture\security-master-identifier-conflict-detection.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\development\accounting-blueprints\README.md` | No hardcoded API keys in docs | error |
| `docs\development\accounting-blueprints\README.md` | No hardcoded localhost URLs in docs | info |
| `docs\development\accounting-blueprints\commitment-and-capital-call-engine.md` | No hardcoded API keys in docs | error |
| `docs\development\accounting-blueprints\commitment-and-capital-call-engine.md` | No hardcoded localhost URLs in docs | info |
| `docs\development\accounting-blueprints\equalization-and-series-accounting.md` | No hardcoded API keys in docs | error |
| `docs\development\accounting-blueprints\equalization-and-series-accounting.md` | No hardcoded localhost URLs in docs | info |
| `docs\development\accounting-blueprints\incentive-fee-mechanics.md` | No hardcoded API keys in docs | error |
| `docs\development\accounting-blueprints\incentive-fee-mechanics.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\development\god-file-burn-down-plan.md` | No hardcoded API keys in docs | error |
| `docs\development\god-file-burn-down-plan.md` | No hardcoded localhost URLs in docs | info |
| `docs\development\mockups\web-ui\README.md` | No hardcoded API keys in docs | error |
| `docs\development\mockups\web-ui\README.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\development\web-ui-structural-improvement-proposal.md` | No hardcoded API keys in docs | error |
| `docs\development\web-ui-structural-improvement-proposal.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\domain\brokerage-account-snapshot.md` | No hardcoded API keys in docs | error |
| `docs\domain\brokerage-account-snapshot.md` | No hardcoded localhost URLs in docs | info |
| `docs\domain\corporate-action-case.md` | No hardcoded API keys in docs | error |
| `docs\domain\corporate-action-case.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\engineering\blueprints\risk-engine-severity-and-decision-journal-blueprint.md` | No hardcoded API keys in docs | error |
| `docs\engineering\blueprints\risk-engine-severity-and-decision-journal-blueprint.md` | No hardcoded localhost URLs in docs | info |
| `docs\engineering\blueprints\w10-mark-001-fail-closed-marks.md` | No hardcoded API keys in docs | error |
| `docs\engineering\blueprints\w10-mark-001-fail-closed-marks.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\engineering\docs-regeneration-automation-design.md` | No hardcoded API keys in docs | error |
| `docs\engineering\docs-regeneration-automation-design.md` | No hardcoded localhost URLs in docs | info |
| `docs\engineering\etl-execution-ownership.md` | No hardcoded API keys in docs | error |
| `docs\engineering\etl-execution-ownership.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\engineering\generated-merge-recovery.md` | No hardcoded API keys in docs | error |
| `docs\engineering\generated-merge-recovery.md` | No hardcoded localhost URLs in docs | info |
| `docs\engineering\live-trading-engine.md` | No hardcoded API keys in docs | error |
| `docs\engineering\live-trading-engine.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\engineering\production-certification-evidence-chain.md` | No hardcoded API keys in docs | error |
| `docs\engineering\production-certification-evidence-chain.md` | No hardcoded localhost URLs in docs | info |
| `docs\engineering\production-readiness-audit-2026-07-27.md` | No hardcoded API keys in docs | error |
| `docs\engineering\production-readiness-audit-2026-07-27.md` | No hardcoded localhost URLs in docs | info |
| `docs\engineering\security-master-architecture-audit-2026-08-13.md` | No hardcoded API keys in docs | error |
| `docs\engineering\security-master-architecture-audit-2026-08-13.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\generated\database\README.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\README.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\asset-operations-contracts-page-01.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\asset-operations-contracts-page-01.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\asset-operations-contracts-page-02.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\asset-operations-contracts-page-02.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\asset-operations-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\asset-operations-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\banking-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\banking-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\direct-lending-contracts-page-01.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\direct-lending-contracts-page-01.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\direct-lending-contracts-page-02.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\direct-lending-contracts-page-02.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\direct-lending-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\direct-lending-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\fund-governance-contracts-page-01.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\fund-governance-contracts-page-01.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\fund-governance-contracts-page-02.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\fund-governance-contracts-page-02.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\fund-governance-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\fund-governance-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\identity-access-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\identity-access-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\ledger-contracts-page-01.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\ledger-contracts-page-01.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\ledger-contracts-page-02.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\ledger-contracts-page-02.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\ledger-contracts-page-03.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\ledger-contracts-page-03.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\ledger-contracts-page-04.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\ledger-contracts-page-04.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\ledger-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\ledger-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\money-market-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\money-market-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\reporting-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\reporting-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\security-master-contracts-page-01.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\security-master-contracts-page-01.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\security-master-contracts-page-02.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\security-master-contracts-page-02.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\security-master-contracts-page-03.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\security-master-contracts-page-03.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\security-master-contracts-page-04.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\security-master-contracts-page-04.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\contracts\security-master-contracts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\contracts\security-master-contracts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\data-object-catalog.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\data-object-catalog.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\asset_operations.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\asset_operations.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\banking.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\banking.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\fund_accounts.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\fund_accounts.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\fund_structure.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\fund_structure.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\identity_access.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\identity_access.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\ledger.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\ledger.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\money_market.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\money_market.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\public.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\public.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\reporting.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\reporting.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\modules\security_master.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\modules\security_master.md` | No hardcoded localhost URLs in docs | info |
| `docs\generated\database\schema-catalog.md` | No hardcoded API keys in docs | error |
| `docs\generated\database\schema-catalog.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\operators\fund-structure-tenant-backfill.md` | No hardcoded API keys in docs | error |
| `docs\operators\fund-structure-tenant-backfill.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\governed-reporting-operations.md` | No hardcoded API keys in docs | error |
| `docs\operators\governed-reporting-operations.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\ledger-currency-backfill.md` | No hardcoded API keys in docs | error |
| `docs\operators\ledger-currency-backfill.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\operator-runbook.md` | No hardcoded API keys in docs | error |
| `docs\operators\operator-runbook.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\operators\security-master-normalized-identifier-migration.md` | No hardcoded API keys in docs | error |
| `docs\operators\security-master-normalized-identifier-migration.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\service-level-objectives.md` | No hardcoded API keys in docs | error |
| `docs\operators\service-level-objectives.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\statement-reconciliation-report-operations.md` | No hardcoded API keys in docs | error |
| `docs\operators\statement-reconciliation-report-operations.md` | No hardcoded localhost URLs in docs | info |
| `docs\operators\verified-outcome-recovery.md` | No hardcoded API keys in docs | error |
| `docs\operators\verified-outcome-recovery.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\plans\report-writer-auto-preview-blueprint.md` | No hardcoded API keys in docs | error |
| `docs\plans\report-writer-auto-preview-blueprint.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\product\adversarial-program-review-2026-07.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-program-review-2026-07.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\adversarial-program-review-2026-08-18.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-program-review-2026-08-18.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\adversarial-program-review-2026-08-24.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-program-review-2026-08-24.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\adversarial-program-review-2026-08-25.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-program-review-2026-08-25.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\adversarial-program-review-2026-08.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-program-review-2026-08.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\adversarial-review-2026-08-remediation-plan.md` | No hardcoded API keys in docs | error |
| `docs\product\adversarial-review-2026-08-remediation-plan.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\product\excel-onboarding-workbook-brainstorm-2026-07.md` | No hardcoded API keys in docs | error |
| `docs\product\excel-onboarding-workbook-brainstorm-2026-07.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\functionality-deepening-brainstorm-2026-07.md` | No hardcoded API keys in docs | error |
| `docs\product\functionality-deepening-brainstorm-2026-07.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\product\next-work-determination-2026-09-20.md` | No hardcoded API keys in docs | error |
| `docs\product\next-work-determination-2026-09-20.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\product\product-roadmap-priorities-2026-07.md` | No hardcoded API keys in docs | error |
| `docs\product\product-roadmap-priorities-2026-07.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\production-readiness-backlog-2026-08.md` | No hardcoded API keys in docs | error |
| `docs\product\production-readiness-backlog-2026-08.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\reporting-operating-model-2026-09.md` | No hardcoded API keys in docs | error |
| `docs\product\reporting-operating-model-2026-09.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\w10-depth-slate-2026-07.md` | No hardcoded API keys in docs | error |
| `docs\product\w10-depth-slate-2026-07.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\w9-close-out-delivery-plan-2026-08.md` | No hardcoded API keys in docs | error |
| `docs\product\w9-close-out-delivery-plan-2026-08.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\w9-demo-002-closure-2026-09-16.md` | No hardcoded API keys in docs | error |
| `docs\product\w9-demo-002-closure-2026-09-16.md` | No hardcoded localhost URLs in docs | info |
| `docs\product\w9-operator-acceptance-2026-08-29.md` | No hardcoded API keys in docs | error |
| `docs\product\w9-operator-acceptance-2026-08-29.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\api-conflict-contract.md` | No hardcoded API keys in docs | error |
| `docs\reference\api-conflict-contract.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\broker-provider-capability-expansion-review.md` | No hardcoded API keys in docs | error |
| `docs\reference\broker-provider-capability-expansion-review.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\database-schema.md` | No hardcoded API keys in docs | error |
| `docs\reference\database-schema.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\interactive-brokers-api-compatibility.md` | No hardcoded API keys in docs | error |
| `docs\reference\interactive-brokers-api-compatibility.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\lifecycle-control-plane.md` | No hardcoded API keys in docs | error |
| `docs\reference\lifecycle-control-plane.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\reference\verified-operation-outcomes.md` | No hardcoded API keys in docs | error |
| `docs\reference\verified-operation-outcomes.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\status\ui-route-wiring-report.md` | No hardcoded API keys in docs | error |
| `docs\status\ui-route-wiring-report.md` | No hardcoded localhost URLs in docs | info |
...
| `docs\testing\accounting-trust-corrections.md` | No hardcoded API keys in docs | error |
| `docs\testing\accounting-trust-corrections.md` | No hardcoded localhost URLs in docs | info |
