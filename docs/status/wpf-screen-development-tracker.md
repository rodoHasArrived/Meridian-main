...
- Source fingerprint: `472b4495a59f`
...
- [x] WPF route/view-model test reference found in tests/Meridian.Wpf.Tests/ViewModels/SecurityPassportEditorViewModelTests.cs.
