# Archived Legacy Status Item: TARGET_END_PRODUCT

This status file has been migrated to [TARGET_END_PRODUCT.md](../../archive/docs/status/TARGET_END_PRODUCT.md). Active status and planning context should be read from canonical owners:
