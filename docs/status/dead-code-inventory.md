# Archived Legacy Status Item: dead-code-inventory

This status file has been migrated to [dead-code-inventory.md](../../archive/docs/status/dead-code-inventory.md). Active status and planning context should be read from canonical owners:
