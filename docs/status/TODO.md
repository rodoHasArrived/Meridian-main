...
| `.github/agents/documentation-agent.md` | 3048 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 2994 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
