...
| `.github/agents/documentation-agent.md` | 3301 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3247 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
