...
| `.github/agents/documentation-agent.md` | 3257 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3203 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
