...
| `.github/agents/documentation-agent.md` | 3223 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3169 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
