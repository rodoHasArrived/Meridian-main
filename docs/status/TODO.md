...
| `.github/agents/documentation-agent.md` | 3145 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3091 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
