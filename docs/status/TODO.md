...
| `.github/agents/documentation-agent.md` | 3158 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3104 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
