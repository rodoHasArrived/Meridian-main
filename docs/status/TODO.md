...
| `.github/agents/documentation-agent.md` | 783 | `TODO` | ❌ | │   │   └── TODO.md |
| `.github/agents/documentation-agent.md` | 3109 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 821 | `TODO` | ❌ | │   │   └── TODO.md |
| `docs/ai/copilot/instructions.md` | 3055 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
