...
| `.github/agents/documentation-agent.md` | 846 | `TODO` | ❌ | │   │   └── TODO.md |
| `.github/agents/documentation-agent.md` | 3408 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `CLAUDE.md` | 899 | `TODO` | ❌ | │   │   └── TODO.md |
| `README.md` | 483 | `TODO` | ❌ | │       │   ├── create-todo-issues.py |
| `README.md` | 950 | `TODO` | ❌ | │   │   ├── TODO.md |
...
| `docs/ai/copilot/instructions.md` | 884 | `TODO` | ❌ | │   │   └── TODO.md |
| `docs/ai/copilot/instructions.md` | 3354 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
