...
| `.github/agents/documentation-agent.md` | 3320 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3266 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
