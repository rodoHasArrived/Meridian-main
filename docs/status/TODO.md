...
| `.github/agents/documentation-agent.md` | 3304 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3250 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
