...
| `.github/agents/documentation-agent.md` | 3184 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3130 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
