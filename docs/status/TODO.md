...
| `.github/agents/documentation-agent.md` | 3248 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3194 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
