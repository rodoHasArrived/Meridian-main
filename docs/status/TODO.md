...
| `.github/agents/documentation-agent.md` | 3044 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 2990 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
