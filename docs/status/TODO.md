...
| `.github/agents/documentation-agent.md` | 3141 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3087 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
