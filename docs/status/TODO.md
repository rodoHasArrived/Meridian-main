...
| `.github/agents/documentation-agent.md` | 3151 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3097 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
