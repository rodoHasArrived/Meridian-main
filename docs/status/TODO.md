...
| `.github/agents/documentation-agent.md` | 3374 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3320 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
