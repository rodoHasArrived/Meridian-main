...
| `.github/agents/documentation-agent.md` | 3271 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `CLAUDE.md` | 418 | `TODO` | ❌ | │       │   ├── create-todo-issues.py |
| `CLAUDE.md` | 884 | `TODO` | ❌ | │   │   └── TODO.md |
| `README.md` | 477 | `TODO` | ❌ | │       │   ├── create-todo-issues.py |
| `README.md` | 933 | `TODO` | ❌ | │   │   ├── TODO.md |
...
| `docs/ai/copilot/instructions.md` | 403 | `TODO` | ❌ | │       │   ├── create-todo-issues.py |
| `docs/ai/copilot/instructions.md` | 869 | `TODO` | ❌ | │   │   └── TODO.md |
| `docs/ai/copilot/instructions.md` | 3217 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
