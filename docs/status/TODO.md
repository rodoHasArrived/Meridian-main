...
| `src/Meridian.Ui/dashboard/src/screens/accounting-screen.view-model.ts` | 6077 | `NOTE` | ❌ | note: event.sourceReason ?? (event.isCurrentProjection ? "Current schedule projection." : null) |
