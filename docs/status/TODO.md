...
| `.github/agents/documentation-agent.md` | 3188 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3134 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
