...
| `.github/agents/documentation-agent.md` | 3144 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3090 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
