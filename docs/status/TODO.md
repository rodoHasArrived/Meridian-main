...
| `.github/agents/documentation-agent.md` | 3380 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3326 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
