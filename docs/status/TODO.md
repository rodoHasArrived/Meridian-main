...
| `.github/agents/documentation-agent.md` | 3236 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3182 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
