...
| `.github/agents/documentation-agent.md` | 3294 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `README.md` | 481 | `TODO` | ❌ | │       │   ├── create-todo-issues.py |
| `README.md` | 940 | `TODO` | ❌ | │   │   ├── TODO.md |
...
| `docs/ai/copilot/instructions.md` | 3240 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
