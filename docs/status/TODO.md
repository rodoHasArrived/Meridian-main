...
| `.github/agents/documentation-agent.md` | 3370 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3316 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
