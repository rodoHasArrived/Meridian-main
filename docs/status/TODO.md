...
| `.github/agents/documentation-agent.md` | 3220 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3166 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
