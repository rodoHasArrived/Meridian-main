...
| `.github/agents/documentation-agent.md` | 3272 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3218 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
