...
| `.github/agents/documentation-agent.md` | 3313 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3259 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
