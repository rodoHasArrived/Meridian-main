...
| `.github/agents/documentation-agent.md` | 3378 | `TODO` | ❌ | - `TODO.md` - Pending work items |
...
| `docs/ai/copilot/instructions.md` | 3324 | `TODO` | ❌ | - `documentation.yml` — Doc generation, TODO scanning, AI error intake |
