...
| `src/Meridian.Ui/dashboard/src/screens/reporting-screen.tsx` | 2789 | `NOTE` | ❌ | note: note \|\| null |
| `src/Meridian.Ui/dashboard/src/screens/reporting-screen.tsx` | 2802 | `NOTE` | ❌ | note: draft.deliveryNote, |
