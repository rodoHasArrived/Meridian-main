# Archived Legacy Status Item: FEATURE_INVENTORY

This status file has been migrated to [FEATURE_INVENTORY.md](../../archive/docs/status/FEATURE_INVENTORY.md). Active status and planning context should be read from canonical owners:
