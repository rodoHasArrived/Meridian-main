# Meridian ADR: ADR-005: Attribute-Based Provider Discovery

**Status:** archive-migration-stub
**Owner:** core-team
**Reviewed:** 2026-05-31
**Retirement path:** `docs/adr/005-attribute-based-discovery.md`
**Replacement:** `archive/docs/adr/005-attribute-based-discovery.md`
...
- Archived copy: [005-attribute-based-discovery.md](../../archive/docs/adr/005-attribute-based-discovery.md)
