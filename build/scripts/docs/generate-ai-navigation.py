...
PROJECT_SEEDS: dict[str, ProjectSeed] = {
    ...
    "Meridian.QuantScript": ProjectSeed(
        ...
        "backtesting-research",
        "strategy-analytics",
        "Strategy analytics and scripting layer for strategy development workflows.",
        ("quantscript", "strategy analytics workflow", "scripting"),
        ("strategy analytics", "script", "quant", "analytics"),
...
SUBSYSTEM_SEEDS: dict[str, SubsystemSeed] = {
    ...
    "backtesting-research": SubsystemSeed(
        ...
        ("backtesting bug", "simulation", "strategy analytics scripting"),
        ("backtesting", "simulation", "strategy analytics", "quantscript"),
    ),
