...
SCRIPT_CONFIG: Dict[str, Dict[str, Sequence[str] | str]] = {
    ...
    "check-ai-contract-drift": {
        ...
        "args": [
            ...
            "--routing-rules",
            "docs/ai/codex/prompt-route-rules.json",
            "--routing-host-doc",
    ...
    "prompt-route-linter": {
        ...
        "output": "docs/status/prompt-route-lint-report.json",
    },
    "handoff-packet-generator": {
        "script": "handoff-packet-generator.py",
        "args": [
            "--route-json",
            "docs/status/prompt-route-lint-report.json",
            "--scope",
            "Docs automation generated handoff packet",
            "--next-lane",
            ...
            "--output",
            "docs/status/ai-handoff-packet.md",
            "--json-output",
            "docs/status/ai-handoff-packet.json",
        ],
        "output": "docs/status/ai-handoff-packet.json",
    },
    "check-handoff-packet-schema": {
        "script": "check-handoff-packet-schema.py",
        "args": [
            "--packet-json",
            "docs/status/ai-handoff-packet.json",
            "--summary",
    ...
    "check-mode-escalation": {
        "script": "check-mode-escalation.py",
        "args": [
            "--route-json",
            "docs/status/prompt-route-lint-report.json",
            "--summary",
    ...
    "check-ai-routing-parity": {
        "script": "check-ai-routing-parity.py",
        "args": [
            "--summary",
        ],
    },
