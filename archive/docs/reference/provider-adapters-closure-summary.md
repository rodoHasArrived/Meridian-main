...
This status file has been migrated to [provider-adapters-closure-summary.md](../../archive/docs/summaries/provider-adapters-closure-summary.md). Active status and planning context should be read from canonical owners:
