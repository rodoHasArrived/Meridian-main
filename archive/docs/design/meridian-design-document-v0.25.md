# Meridian Design Document — Version 0.25 (archived)

**Status:** archived
**Owner:** core-team
**Reviewed:** 2026-07-28
**Replacement:** [docs/product/meridian-design-document.md](../../../docs/product/meridian-design-document.md)

This is the full text of the superseded Version 0.25 design charter, preserved when the canonical
charter was rewritten as Version 1.0 on 2026-07-28. It is retained for historical traceability and
evidence value only. It is not a canonical source of truth; use the replacement link above.
...
[`docs/architecture/core-extensibility-model.md`](../../../docs/architecture/core-extensibility-model.md).
...
[`docs/architecture/design-document-adaptation.md`](../../../docs/architecture/design-document-adaptation.md),
with physical module conformance covered by
[`docs/architecture/design-module-conformance.md`](../../../docs/architecture/design-module-conformance.md).
...
The canonical execution and readiness tracker is [Implementation and Readiness Tracker](../../../docs/product/implementation-todo-list.md). Keep detailed implementation, evidence, and readiness status changes in that file so the design document remains the product rationale rather than a duplicate execution tracker.
