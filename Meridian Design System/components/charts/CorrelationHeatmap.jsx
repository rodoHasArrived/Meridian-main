...
.mds-corr__h{background:var(--bg-medium,#F5F7FA);color:var(--text-secondary,#4E5258);
...
.mds-corr__cell--diag{color:var(--text-muted,#5E666F);background:var(--bg-active,#E6EEF5)!important;}
