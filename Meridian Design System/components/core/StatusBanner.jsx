...
export function StatusBanner({ tone = "success", title, detail }) {
  const c = {
    success: { bg: "var(--green-a10, rgba(22,136,95,.10))",  bd: "var(--green, #16885F)",  fg: "var(--green-dim, #126C4D)" },
    warning: { bg: "var(--orange-a10, rgba(183,121,31,.10))", bd: "var(--orange, #B7791F)", fg: "var(--orange-dim, #946216)" },
    danger:  { bg: "var(--red-a10, rgba(186,63,85,.10))",     bd: "var(--red, #BA3F55)",    fg: "var(--red-dim, #983244)" },
