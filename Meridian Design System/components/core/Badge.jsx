...
.mds-badge--neutral{background:var(--bg-hover,#F1F4F7);border-color:var(--border,#D7DCE2);color:var(--text-secondary,#4E5258);}
.mds-badge--info{background:var(--blue-a10,rgba(47,111,143,.10));border-color:var(--accent,#A85436);color:var(--accent,#A85436);}
.mds-badge--success{background:var(--green-a10,rgba(22,136,95,.10));border-color:var(--green,#3A7A56);color:var(--green-dim,#10663F);}
.mds-badge--warning{background:var(--orange-a10,rgba(183,121,31,.10));border-color:var(--orange,#8A5C12);color:var(--orange-dim,#683E0B);}
.mds-badge--danger{background:var(--red-a10,rgba(186,63,85,.10));border-color:var(--red,#A8443C);color:var(--red-dim,#8C2F40);}
