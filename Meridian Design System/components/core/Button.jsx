...
.mds-btn:disabled{cursor:not-allowed;background:var(--bg-medium,#F5F7FA);border-color:var(--border,#D7DCE2);color:var(--text-disabled,#94999F);}
/* sizes */
...
.mds-btn--ghost{background:var(--bg-light,#fff);border-color:var(--border,#D7DCE2);color:var(--text-primary,#22252A);}
...
.mds-btn--danger{background:var(--bg-light,#fff);border-color:var(--border,#D7DCE2);color:var(--red,#A8443C);font-weight:600;}
