...
.mds-cb-opt--active{background:var(--bg-active,#E1EAF2);color:var(--accent,#A85436);font-weight:600;}
...
.mds-cb-mark{background:var(--accent-ghost,#E8F0F7);color:var(--accent,#A85436);}
`;
