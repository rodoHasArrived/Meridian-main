...
.mds-seg__btn:hover:not(.mds-seg__btn--active):not(:disabled){color:var(--text-primary,#22252A);background:var(--bg-hover,#F1F4F7);}
.mds-seg__btn--active{color:var(--text-primary,#22252A);background:var(--bg-light,#FAFBFC);
