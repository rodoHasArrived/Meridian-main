...
.tlt__hp--short{background:var(--orange-a10,rgba(183,121,31,.10));border-color:var(--orange,#8A5C12);color:var(--orange-dim,#683E0B);}
          ...
          {computed.map((r, i) => (
            <tr key={r.id ?? i}>
              ...
              <td className="tlt--r">
                ...
                {isFinite(r.pct) && (
                  <span className="tlt__pct" style={{ color: r.gain < 0 ? "var(--red-dim,#8C2F40)" : r.gain > 0 ? "var(--green-dim,#10663F)" : "var(--text-muted,#5E666F)" }}>
