...
.rec__seg button{appearance:none;border:none;background:transparent;cursor:pointer;
  ...
  color:var(--text-muted,#5E666F);padding:4px 10px;line-height:1.4;border-left:1px solid var(--border,#D7DCE2);}
.rec__seg button:first-child{border-left:none;}
.rec__seg button[aria-pressed="true"]{background:var(--bg-medium,#F5F7FA);color:var(--text-primary,#22252A);box-shadow:inset 0 -2px 0 var(--accent,#0A5E3E);}
...
.rec__chip--ok{background:var(--green-a10,rgba(22,136,95,.10));border-color:var(--green,#3A7A56);color:var(--green-dim,#10663F);}
.rec__chip--open{background:var(--orange-a10,rgba(183,121,31,.10));border-color:var(--orange,#8A5C12);color:var(--orange-dim,#683E0B);}
...
.rec__table th{position:sticky;top:0;background:var(--bg-light,#fff);text-align:left;
  ...
  color:var(--text-muted,#5E666F);padding:6px 10px;border-bottom:1px solid var(--border,#D7DCE2);
...
.rec__statusbox--bal{background:var(--green-a10,rgba(22,136,95,.10));border-color:var(--green,#3A7A56);color:var(--green-dim,#10663F);}
.rec__statusbox--out{background:var(--red-a10,rgba(186,63,85,.10));border-color:var(--red,#A8443C);color:var(--red-dim,#8C2F40);}
