...
.mds-colmgr__btn:hover{background:var(--bg-active,#E6EEF5);border-color:var(--accent,#A85436);}
...
.mds-colmgr__ic:hover:not(:disabled){background:var(--bg-active,#E6EEF5);color:var(--text-primary,#22252A);}
