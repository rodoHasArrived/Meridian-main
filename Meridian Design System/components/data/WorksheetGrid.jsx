...
.mds-ws__ref{width:60px;flex:none;display:flex;align-items:center;justify-content:center;border-right:1px solid var(--border,#D7DCE2);background:var(--bg-medium,#F5F7FA);font:600 13px var(--font-data);color:var(--text-primary,#22252A);}
.mds-ws__fx{width:32px;flex:none;display:flex;align-items:center;justify-content:center;border-right:1px solid var(--border,#D7DCE2);font:italic 600 12px var(--font-display);color:var(--text-muted,#5E666F);}
...
.mds-ws__hdr,.mds-ws__rownum{box-sizing:border-box;display:flex;align-items:center;justify-content:center;font:600 11px var(--font-data);color:var(--text-muted,#5E666F);background:var(--bg-medium,#F5F7FA);}
