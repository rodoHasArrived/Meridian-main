...
.fdt-table th {
  ...
  color: var(--text-muted, #5E666F); border-bottom: 1px solid var(--border, #D7DCE2);
...
.fdt-table tbody tr:hover { background: var(--bg-active, #E6EEF5); box-shadow: inset 3px 0 0 var(--accent, #A85436); }
