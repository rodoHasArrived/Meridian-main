...
The full generated repository tree is intentionally kept out of the root README to avoid committing volatile build, screenshot, and local artifact listings. Regenerate or inspect the current structure with:

```bash
python3 build/scripts/docs/generate-structure-docs.py
```

See [docs/generated/repository-structure.md](docs/generated/repository-structure.md) for the generated structure report and [docs/architecture/project-structure.md](docs/architecture/project-structure.md) for the maintained project map.
