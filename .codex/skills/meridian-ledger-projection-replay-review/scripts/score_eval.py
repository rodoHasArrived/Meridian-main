#!/usr/bin/env python3
"""Score Meridian ledger projection/replay review outputs with a compact rubric."""
...
RUBRIC = {
    "replay_controls": "Checks idempotent replay, duplicate detection, out-of-order handling, and deterministic ordering.",
    "projection_boundary": "Separates immutable journal facts from rebuildable read models and UI snapshots.",
    "versioning_rebuild": "Names projection versioning, backfill, rebuild checkpoints, and migration posture.",
    "drift_provenance": "Identifies balance drift detection and report-line provenance.",
