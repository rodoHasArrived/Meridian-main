#!/usr/bin/env python3
"""Score Meridian code architecture skill outputs with a compact rubric."""
...
RUBRIC = {
    "boundary_integrity": "Correctly identifies allowed and risky module dependencies.",
    "repo_evidence": "Grounds claims in module map, project structure, source docs, ADRs, or project references.",
    "implementation_handoff": "Names owner layer, public seam, docs, tests, and next skill handoff.",
    "validation_plan": "Includes narrow commands that prove architecture-sensitive changes.",
    "traceable_summary": "Links architecture question to evidence and residual risk.",
}
