#!/usr/bin/env python3
"""Score Meridian accounting posting-controls outputs with a compact rubric."""
...
RUBRIC = {
    "control_matrix": "Names source evidence, approval, period posture, idempotency, dates, and concurrency controls.",
    "double_entry": "Checks balanced debit/credit impact and accounting consequence.",
    "fail_closed": "Identifies missing gates and disabled reasons before posting.",
    "correction_path": "Uses reversal/rebook, amendment, or restatement instead of mutation.",
    "handoff_validation": "Names impacted seams, tests, validation commands, and residual risk.",
}
