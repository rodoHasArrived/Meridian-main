#!/usr/bin/env python3
"""Validate the Meridian accounting posting-controls skill package."""
...
REFERENCE = SKILL_DIR / "references" / "posting-control-checklist.md"
AGENT_PROFILE = REPO_ROOT / ".codex" / "agents" / "meridian-accounting-posting-controls.toml"
...
REQUIRED_AGENT_LINKS = [
    "`.codex/skills/meridian-accounting-posting-controls/SKILL.md`",
...
SCENARIOS = {
    "approval-period-gates": {
        "description": "approval, reviewer state, period posture, and disabled reasons are visible",
        "required_terms": [
            "approval",
            "reviewer state",
            "period posture",
    ...
    "idempotency-concurrency": {
        "description": "idempotency, source version, stale-version, correlation, and concurrency controls are visible",
        "required_terms": [
            "idempotency key",
            "source version",
            "stale-version",
    ...
    "reversal-rebook-controls": {
        "description": "corrections preserve posted facts through reversal/rebook, amendment, or restatement",
        "required_terms": [
            "reversal/rebook",
            "amendment",
            "restatement",
...
def main() -> int:
    ...
    missing_reference = [] if reference_text and "fail-closed conditions" in reference_text else ["posting-control-checklist.md fail-closed conditions"]
