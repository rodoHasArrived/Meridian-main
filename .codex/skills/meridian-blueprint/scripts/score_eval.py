#!/usr/bin/env python3
"""Score Meridian blueprint outputs with a compact deterministic rubric."""
...
RUBRIC = {
    "scope_control": "States selected goal, assumptions, and out-of-scope items.",
    "repo_grounding": "Names real Meridian paths, contracts, or abstractions.",
    "decision_completeness": "Includes interfaces, data flow, edge cases, and risks.",
    "validation_quality": "Names narrow validation commands for touched layers.",
}
