#!/usr/bin/env python3
"""Run deterministic evals for the Meridian event accounting architecture skill."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Run local deterministic fixtures.")
