...
- `src/Meridian.Wpf/`: deferred WPF shell retained for compatibility and historical evidence
...
- `src/Meridian.Wpf/Shell/`: deferred WPF shell route, launch, session, refresh, and presentation seams
- `src/Meridian.Wpf/ViewModels/MainPageViewModel.cs`: deferred WPF desktop shell view model and workstation navigation anchor
