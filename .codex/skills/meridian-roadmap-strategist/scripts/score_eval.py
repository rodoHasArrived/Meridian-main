#!/usr/bin/env python3
"""Score Meridian roadmap strategist outputs with a compact deterministic rubric."""
...
RUBRIC = {
    "evidence_grounding": "Separates repo evidence from assumptions.",
    "status_clarity": "Distinguishes complete, partial, planned, optional, and blocked work.",
    "wave_quality": "Sequences recommendations by user value and dependency.",
    "scope_discipline": "Keeps deferred lanes out of active scope unless evidence moves them.",
}
