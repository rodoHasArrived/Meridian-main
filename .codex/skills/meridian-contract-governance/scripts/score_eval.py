#!/usr/bin/env python3
"""Score Meridian contract governance skill outputs with a compact rubric."""
...
RUBRIC = {
    "compatibility_classification": "Classifies the contract change as additive, preserving, breaking, or removal.",
    "consumer_coverage": "Maps services, browser, WPF, tests, and docs consumers.",
    "test_mapping": "Names narrow tests or builds for the impacted consumers.",
    "documentation_sync": "Identifies docs or source README updates needed for public contract changes.",
    "traceable_summary": "Links changed contract to consumers, validation, docs, and residual risk.",
}
