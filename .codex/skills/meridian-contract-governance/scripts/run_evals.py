#!/usr/bin/env python3
"""Run deterministic eval cases for the Meridian contract governance skill."""
...
def check_expectations(case: dict[str, Any], completed: subprocess.CompletedProcess[str]) -> EvalResult:
    ...
    return EvalResult(case["id"], case["description"], "pass" if not failures else "fail", checks + failures, exit_code=completed.returncode)
