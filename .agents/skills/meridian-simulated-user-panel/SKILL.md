...
> **Codex agent equivalent:** [`.Codex/agents/meridian-user-panel.md`](../../../.Codex/agents/meridian-user-panel.md)
...
```bash
python .Codex/skills/meridian-simulated-user-panel/scripts/run_eval.py list
python .Codex/skills/meridian-simulated-user-panel/scripts/run_eval.py materialize --eval-id 2
python .Codex/skills/meridian-simulated-user-panel/scripts/run_eval.py score --workspace .Codex/skills/meridian-simulated-user-panel/tmp-evals/eval-02-provider-onboarding-release-gate
python .Codex/skills/meridian-simulated-user-panel/scripts/run_eval.py aggregate --input .Codex/skills/meridian-simulated-user-panel/tmp-evals
python .Codex/skills/meridian-simulated-user-panel/scripts/run_eval.py compare-baseline --aggregate .Codex/skills/meridian-simulated-user-panel/tmp-evals/aggregate.json
```
