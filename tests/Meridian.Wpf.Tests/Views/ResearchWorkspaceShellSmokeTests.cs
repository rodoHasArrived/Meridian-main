...
public sealed class ResearchWorkspaceShellSmokeTests
{
    [Fact]
    public void ResearchWorkspaceShell_ShouldConstructFromDi()
    {
        WpfTestThread.Run(() =>
        {
            ...
            var exception = Record.Exception(() =>
                serviceProvider.GetRequiredService<ResearchWorkspaceShellPage>());
