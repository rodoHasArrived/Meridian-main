...
public sealed class IBRuntimeGuidanceTests
{
    ...
    public void IbSimulationClient_Metadata_PointsToSetupDoc()
    {
        ...
        client.ProviderDescription.Should().Contain("docs/operators/provider-onboarding-interactive-brokers.md");
        client.ProviderNotes.Should().Contain(note =>
            note.Contains("docs/operators/provider-onboarding-interactive-brokers.md"));
    ...
    public void IbHistoricalProvider_Metadata_PointsToSetupDocAndSmokeBuildPath()
    {
        ...
        provider.Description.Should().Contain("docs/operators/provider-onboarding-interactive-brokers.md");
        provider.ProviderNotes.Should().Contain(note => note.Contains("build-ibapi-smoke.ps1"));
        provider.ProviderWarnings.Should().Contain(warning =>
            warning.Contains("docs/operators/provider-onboarding-interactive-brokers.md"));
    }
