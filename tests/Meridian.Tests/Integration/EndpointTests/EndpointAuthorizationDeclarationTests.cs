...
public sealed class EndpointAuthorizationDeclarationTests : EndpointIntegrationTestBase
{
    ...
    private static readonly HashSet<string> UndeclaredMutationBaseline = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "DELETE /api/workstation/reconciliation/statement-fetch-schedules/{scheduleId}",
        "DELETE /api/workstation/reconciliation/statement-mapping-profiles/{profileId}",
        ...
        "POST /api/accounting-system/export-packages",
        "POST /api/accounting-system/export-packages/certification",
        "POST /api/accounting-system/import/preview",
        "POST /api/accounting-system/mapping-profiles",
        "POST /api/accounting-system/migration-run-artifacts",
        "POST /api/accounting-system/migration-runs",
        "POST /api/accounting-system/migration-worker-plans",
        "POST /api/accounting-system/production-certification-profile",
        "POST /api/accounting-system/production-readiness",
        "POST /api/accounting-system/tenant-administration-profile",
        ...
        "POST /api/auth/access-assignments",
        ...
        "POST /api/ledger/accounting-configuration/activate",
        "POST /api/ledger/accounting-configuration/asset-accounting/events/lifecycle",
        "POST /api/ledger/accounting-configuration/asset-accounting/events/project",
        "POST /api/ledger/accounting-configuration/chart",
        "POST /api/ledger/accounting-configuration/posting-rules",
        "POST /api/ledger/accounting-configuration/posting-rules/candidates",
        "POST /api/ledger/accounting-configuration/posting-rules/candidates/asset-accounting",
        "POST /api/ledger/accounting-configuration/posting-rules/candidates/post",
        "POST /api/ledger/accounting-configuration/posting-rules/dry-run",
        "POST /api/ledger/accounting-configuration/posting-rules/projection-sets",
        "POST /api/ledger/accounting-configuration/posting-rules/promotion-approvals",
        "POST /api/ledger/accounting-configuration/posting-rules/test-cases",
        "POST /api/ledger/accounting-configuration/posting-rules/tests",
        "POST /api/ledger/accounting-configuration/preview",
        "POST /api/ledger/accounting-configuration/templates",
        "POST /api/ledger/books",
        "POST /api/ledger/books/rollout-assessment",
        "POST /api/ledger/close-management/evidence-review",
        "POST /api/ledger/close-management/late-adjustments",
        "POST /api/ledger/close-management/late-adjustments/review",
        "POST /api/ledger/close-management/period-lock",
        "POST /api/ledger/close-management/period-plan/configuration",
        "POST /api/ledger/close-management/period-reopen",
        "POST /api/ledger/close-management/task-signoffs",
        "POST /api/ledger/journal-automation/daily-mark-to-market-batch-lifecycle",
        "POST /api/ledger/journal-automation/daily-mark-to-market-intake",
        "POST /api/ledger/journal-automation/daily-mark-to-market-run-due",
        "POST /api/ledger/journal-automation/daily-mark-to-market-schedules",
        "POST /api/ledger/journal-automation/dividend-intake",
        "POST /api/ledger/journal-automation/fee-accrual-intake",
        "POST /api/ledger/journal-automation/monthly-schedules",
        "POST /api/ledger/journal-automation/monthly-schedules/run-due",
        "POST /api/ledger/journal-automation/period-close-intake",
        "POST /api/ledger/journal-entry-workbench/drafts",
        "POST /api/ledger/journal-entry-workbench/evidence",
        "POST /api/ledger/journal-entry-workbench/lifecycle-action",
        "POST /api/ledger/journal-entry-workbench/submit-approval",
        "POST /api/ledger/journal-entry-workbench/validate",
        "POST /api/ledger/periods",
        "POST /api/ledger/periods/{periodId:guid}/close",
        "POST /api/ledger/reports/accounting-package",
        "POST /api/ledger/reports/accounting-package/certification",
        ...
        "POST /api/workstation/data/ingestion-operations/{jobId}/actions/{action}",
        "POST /api/workstation/data/query",
        "POST /api/workstation/data/storage-assurance/actions/execute",
        "POST /api/workstation/data/storage-assurance/actions/preview",
        "POST /api/workstation/data/uploads/bank-statements/import",
        "POST /api/workstation/data/uploads/preview",
        "POST /api/workstation/data/uploads/workbook/preview",
        ...
        "POST /api/workstation/operations/continuity",
        "POST /api/workstation/operations/continuity/approval-policy-rules",
        "POST /api/workstation/operations/continuity/close-calendar-items",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/approval/approve",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/approval/reject",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/approval/submit",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/broker/import",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/broker/normalize",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/checklist/{taskId}/acknowledge",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/close",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/ledger/draft",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/ledger/post",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/ledger/validate",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/posture/refresh",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/reconciliation/breaks/{breakId}/assign",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/reconciliation/breaks/{breakId}/resolve",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/reconciliation/run",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/reopen",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/security-master/overrides/{overrideId}/approve",
        "POST /api/workstation/operations/continuity/{workflowId:guid}/security-master/resolve",
        "POST /api/workstation/reconciliation/break-queue/bulk/dry-run",
        "POST /api/workstation/reconciliation/break-queue/bulk/execute",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/assign",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/comments",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/comments/{commentId}",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/reopen",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/resolution",
        ...
        "POST /api/workstation/reconciliation/break-queue/{breakId}/root-cause",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/sign-off",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/supersede",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/transition",
        "POST /api/workstation/reconciliation/break-queue/{breakId}/waive",
        "POST /api/workstation/reconciliation/margin-control/certifications",
        "POST /api/workstation/reconciliation/runs",
        "POST /api/workstation/reconciliation/statement-fetch-schedules",
        "POST /api/workstation/reconciliation/statement-fetch-schedules/{scheduleId}/run",
        "POST /api/workstation/reconciliation/statement-imports/commit",
        "POST /api/workstation/reconciliation/statement-imports/fetch-preview",
        "POST /api/workstation/reconciliation/statement-imports/preview",
        "POST /api/workstation/reconciliation/statement-reconciliation-report",
        "POST /api/workstation/reconciliation/statement-reconciliation-report/{workflowId}/resume",
        "POST /api/workstation/reconciliation/statement-runs",
        "POST /api/workstation/reconciliation/statement-runs/{runId}/reconcile",
        "POST /api/workstation/reconciliation/statement-to-report",
        "POST /api/workstation/reconciliation/statement-to-report/{workflowId}/resume",
        ...
        "POST /api/workstation/strategy/designer/drafts",
        "POST /api/workstation/strategy/designer/preview",
        "POST /api/workstation/strategy/designer/run-backtest",
        ...
        "PUT /api/workstation/reconciliation/statement-mapping-profiles",
        "PUT /api/workstation/settings/feature-capabilities/{capabilityKey}",
