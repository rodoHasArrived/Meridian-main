...
- Generated: 2026-04-25T09:23:32.1226192Z
...
|---|---|---|---:|---|
| Meridian.Tests build | build | passed | 8.83 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/meridian-tests-build.log` |
| Alpaca core provider confidence | test | passed | 5.11 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/alpaca-core-provider-confidence.log` |
| Robinhood supported surface | test | passed | 9.11 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/robinhood-supported-surface.log` |
| Yahoo historical-only core provider | test | passed | 3.82 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/yahoo-historical-only-core-provider.log` |
| Checkpoint reliability and gap handling | test | passed | 7.67 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/checkpoint-reliability-and-gap-handling.log` |
| Parquet sink and conversion | test | passed | 3.98 | `artifacts/provider-validation/_automation/codex-dk1-packet-validation-final/parquet-sink-and-conversion.log` |
