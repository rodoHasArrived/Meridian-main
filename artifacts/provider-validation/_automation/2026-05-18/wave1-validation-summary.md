...
- Generated: 2026-05-19T07:31:50.3923066Z
...
|---|---|---|---:|---|
| Meridian.Tests build | build | passed | 0 | `artifacts/provider-validation/_automation/2026-05-18/meridian-tests-build.log` |
| Alpaca core provider confidence | test | failed | 204.53 | `artifacts/provider-validation/_automation/2026-05-18/alpaca-core-provider-confidence.log` |
| Robinhood supported surface | test | failed | 21.91 | `artifacts/provider-validation/_automation/2026-05-18/robinhood-supported-surface.log` |
| Yahoo historical-only core provider | test | passed | 0 | `artifacts/provider-validation/_automation/2026-05-18/yahoo-historical-only-core-provider.log` |
| Checkpoint reliability and gap handling | test | passed | 0 | `artifacts/provider-validation/_automation/2026-05-18/checkpoint-reliability-and-gap-handling.log` |
| Parquet sink and conversion | test | passed | 0 | `artifacts/provider-validation/_automation/2026-05-18/parquet-sink-and-conversion.log` |
