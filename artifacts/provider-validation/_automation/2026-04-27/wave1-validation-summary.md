...
- Generated: 2026-04-27T04:43:54.8126943Z
...
|---|---|---|---:|---|
| Meridian.Tests build | build | passed | 240.52 | `artifacts/provider-validation/_automation/2026-04-27/meridian-tests-build.log` |
| Alpaca core provider confidence | test | passed | 16.75 | `artifacts/provider-validation/_automation/2026-04-27/alpaca-core-provider-confidence.log` |
| Robinhood supported surface | test | passed | 9.41 | `artifacts/provider-validation/_automation/2026-04-27/robinhood-supported-surface.log` |
| Yahoo historical-only core provider | test | passed | 6.73 | `artifacts/provider-validation/_automation/2026-04-27/yahoo-historical-only-core-provider.log` |
| Checkpoint reliability and gap handling | test | passed | 9.58 | `artifacts/provider-validation/_automation/2026-04-27/checkpoint-reliability-and-gap-handling.log` |
| Parquet sink and conversion | test | passed | 7.33 | `artifacts/provider-validation/_automation/2026-04-27/parquet-sink-and-conversion.log` |
