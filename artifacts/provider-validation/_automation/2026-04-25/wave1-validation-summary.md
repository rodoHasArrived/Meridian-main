...
- Generated: 2026-04-25T06:59:54.6560953Z
...
|---|---|---|---:|---|
| Meridian.Tests build | build | passed | 30.22 | `artifacts/provider-validation/_automation/2026-04-25/meridian-tests-build.log` |
| Alpaca core provider confidence | test | passed | 6.34 | `artifacts/provider-validation/_automation/2026-04-25/alpaca-core-provider-confidence.log` |
| Robinhood supported surface | test | passed | 7.06 | `artifacts/provider-validation/_automation/2026-04-25/robinhood-supported-surface.log` |
| Yahoo historical-only core provider | test | passed | 3.81 | `artifacts/provider-validation/_automation/2026-04-25/yahoo-historical-only-core-provider.log` |
| Checkpoint reliability and gap handling | test | passed | 4.8 | `artifacts/provider-validation/_automation/2026-04-25/checkpoint-reliability-and-gap-handling.log` |
| Parquet sink and conversion | test | passed | 4.81 | `artifacts/provider-validation/_automation/2026-04-25/parquet-sink-and-conversion.log` |
