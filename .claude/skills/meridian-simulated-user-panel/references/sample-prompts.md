...
Use $meridian-simulated-user-panel in design_partner mode with this manifest:
{
  ...
  "artifact_evidence": [
    {"path": "docs/plans/example-roadmap-item.md", "kind": "roadmap", "status": "supplied"}
  ],
  "artifact_freshness": "unknown",
  "persona_set": {"panel": "core-finance", "required_roles": ["CIO"]},
...
Use $meridian-simulated-user-panel in release_gate mode with this manifest:
{
  ...
  "artifact_evidence": [
    {"path": "artifacts/desktop-workflows/provider-flow/manifest.json", "kind": "workflow-manifest", "status": "verified"},
    {"path": "artifacts/desktop-workflows/provider-flow/screenshots/01-start.png", "kind": "screenshot", "status": "verified"}
  ],
  "artifact_freshness": "current",
  "persona_set": {"panel": "operations-controls", "required_roles": ["Operations Manager", "Integration Administrator"]},
...
Use $meridian-simulated-user-panel in usability_lab mode with this manifest:
{
  ...
  "artifact_evidence": [
    {"path": "docs/screenshots/desktop/fund-ledger.png", "kind": "screenshot", "status": "supplied"},
    {"path": "docs/screenshots/desktop/approvals-panel.png", "kind": "screenshot", "status": "supplied"}
  ],
  "artifact_freshness": "current",
