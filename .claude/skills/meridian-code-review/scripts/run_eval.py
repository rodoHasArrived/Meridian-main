...
def run_single_query(  # noqa: C901
    ...
    try:
        ...
        buffer = stdout.decode("utf-8", errors="replace") if stdout else ""
...
def main():
    ...
    if shutil.which(claude_bin) is None:
        print(
            f"Error: Claude CLI '{claude_bin}' was not found on PATH. "
            "Install Claude Code or set CLAUDE_BIN to the executable path before running trigger evals.",
            file=sys.stderr,
        )
        sys.exit(2)
