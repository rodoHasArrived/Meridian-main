...
public static class UiApiRoutes
{
    ...
    public const string SecurityMasterWorkbenchDiscard = "/api/security-master/{securityId:guid}/workbench/discard";
    ...
    public const string WorkstationProviderIntegrationOpenApiImport = "/api/workstation/provider-integrations/import/openapi";
    public const string WorkstationProviderIntegrationSetupSave = "/api/workstation/provider-integrations/setup";
    ...
    public const string LedgerBookRolloutAssessment = "/api/ledger/books/rollout-assessment";
