...
public static class WorkstationWorkspaceCatalog
{
    ...
    public const string TradingBrowserStatus = "Review";
    ...
    public const string PortfolioBrowserStatus = "Preview";
    ...
    public const string AccountingBrowserStatus = "Review";
    ...
    public const string ReportingBrowserStatus = "Review";
    ...
    public const string StrategyBrowserStatus = "Paper";
    ...
    public const string DataBrowserStatus = "Live";
    ...
    public const string SettingsBrowserStatus = "Setup";
