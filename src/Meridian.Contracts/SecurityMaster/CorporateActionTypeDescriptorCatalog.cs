...
public static class CorporateActionTypeDescriptorCatalog
{
    ...
    [
        ...
        new(
            CanonicalName: CorporateActionEventTypes.RightsDistribution,
            CaevCode: "RHDI",
            DisplayName: "Rights distribution",
            Description: "Rights or warrants are distributed to existing holders; distribution and later exercise remain separate source events.",
            Aliases: ["RightsDistributionEvent", "RightsEntitlement"],
            ValidSecurityMasterAssetClasses: ["Equity", "Warrant"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["zero-basis rights receipt", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.RightsExercise,
            CaevCode: "EXRI",
            DisplayName: "Rights exercise",
            Description: "Distributed rights or warrants are exercised into an underlying security for the stated exercise consideration.",
            Aliases: ["RightsExerciseEvent", "ExerciseRights"],
            ValidSecurityMasterAssetClasses: ["Equity", "Warrant"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["rights removal", "underlying purchase", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.Rule144ARegSExchange,
            CaevCode: null,
            DisplayName: "144A/RegS exchange",
            Description: "A restricted security is exchanged between Rule 144A and Regulation S forms while preserving issuer-level economic lineage.",
            Aliases: ["144A/RegS Exchange", "144ARegSExchange", "RegS144AExchange"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit"],
            RequiredFields: [CorporateActionField.NewSecurityId, CorporateActionField.ExchangeRatio],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["book-value conserving exchange", "holding-period carryover", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.AdvanceRefunding,
            CaevCode: null,
            DisplayName: "Advance refunding",
            Description: "A debt issue is allocated between refunded and unrefunded successor securities.",
            Aliases: ["PreRefunding", "AdvanceRefundedBond"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["basis allocation between successors", "holding-period carryover", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.BankruptcyDistribution,
            CaevCode: null,
            DisplayName: "Bankruptcy distribution",
            Description: "Cash, escrow interests, successor securities, or a zero-value disposition arising from bankruptcy proceedings.",
            Aliases: ["Bankruptcy", "ReorganizationDistribution", "Chapter11Distribution"],
            ValidSecurityMasterAssetClasses: ["Equity", "Bond", "StructuredCredit", "PrivateCompanyEquity"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.None,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["independent terms review required", "unsupported branches remain blocked"]),
        new(
            CanonicalName: CorporateActionEventTypes.ConsentSolicitation,
            CaevCode: "CONS",
            DisplayName: "Consent solicitation",
            Description: "Issuer solicitation of holder consent, optionally including a consent payment and amended terms.",
            Aliases: ["Consent", "ConsentPayment", "CONS"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.None,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["retain holder response evidence", "terms update remains source evidence"]),
        new(
            CanonicalName: CorporateActionEventTypes.Conversion,
            CaevCode: "CONV",
            DisplayName: "Conversion",
            Description: "A convertible debt, preferred, warrant, or other security converts into a successor security.",
            Aliases: ["DebtToEquityConversion", "SecurityConversion", "CONV"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit", "Equity", "Warrant"],
            RequiredFields: [CorporateActionField.NewSecurityId, CorporateActionField.ExchangeRatio],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["position conversion", "cash boot reviewed separately", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.ExchangeOffer,
            CaevCode: "EXOF",
            DisplayName: "Exchange offer",
            Description: "A voluntary or mandatory offer to exchange an existing security for new securities and optionally cash.",
            Aliases: ["DebtExchangeOffer", "SecurityExchangeOffer", "EXOF"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit", "Equity", "PrivateCompanyEquity"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.None,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["taxability and materiality require reviewed policy", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.FractionalUnitsCashInLieu,
            CaevCode: null,
            DisplayName: "Fractional units / cash in lieu",
            Description: "A fractional residual is disposed and cash is received in lieu of issuing the fractional unit.",
            Aliases: ["CashInLieu", "FractionalCash", "CIL"],
            ValidSecurityMasterAssetClasses: ["Equity", "Warrant", "PrivateCompanyEquity"],
            RequiredFields: [CorporateActionField.Currency],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.None,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["fractional disposal", "cash consideration", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.PaymentInKind,
            CaevCode: null,
            DisplayName: "Payment in kind",
            Description: "Income is satisfied through additional securities or principal rather than cash.",
            Aliases: ["PIK", "Payment-In-Kind", "InKindCoupon"],
            ValidSecurityMasterAssetClasses: ["Bond", "StructuredCredit", "DirectLoan", "Equity", "PrivateFundInterest"],
            RequiredFields: [],
            AdjustmentBehavior: CorporateActionAdjustmentBehavior.PositionTransformation,
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["income and successor purchase remain distinct consequences", "no automatic accounting approval"]),
        new(
            CanonicalName: CorporateActionEventTypes.PutRedemption,
            CaevCode: "BPUT",
            DisplayName: "Put redemption",
            Description: "A holder exercises a put provision requiring early repayment at the contractual put price.",
            Aliases: ["BondPut", "PutExercise", "BPUT"],
            ...
            LedgerPostingKind: CorporateActionLedgerPostingKind.None,
            IsPriceAffecting: false,
            LedgerBehaviorHints: ["voluntary holder election", "taxable-treatment assertion requires review"]),
        new(
