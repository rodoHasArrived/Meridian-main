...
const WORKSPACE_SUBROUTES: Partial<Record<WorkspaceKey, WorkspaceSubrouteDefinition[]>> = {
  ...
  accounting: [
    ...
    { label: "Close Calendar", route: WORKSTATION_ROUTE_CATALOG.accountingCloseCalendar },
    ...
    { label: "Account Detail", route: WORKSTATION_ROUTE_CATALOG.accountingAccountDetail },
    ...
    { label: "Match Workbench", route: WORKSTATION_ROUTE_CATALOG.accountingReconciliationMatch },
    ...
    { label: "Approval Inbox", route: WORKSTATION_ROUTE_CATALOG.accountingApprovalInbox },
    { label: "Evidence", route: WORKSTATION_ROUTE_CATALOG.accountingEvidence },
    { label: "Evidence Detail", route: WORKSTATION_ROUTE_CATALOG.accountingEvidenceDetail },
  ...
  reporting: [
    ...
    { label: "Preview & Validation", route: WORKSTATION_ROUTE_CATALOG.reportingPreviewValidation },
    { label: "Run Detail", route: WORKSTATION_ROUTE_CATALOG.reportingRunDetail },
