...
function summarizeReferenceDataRoutes(endpoints: ReferenceDataEndpointProbeResult[]): ReferenceDataRoutePostureCounts {
...
function formatSecurityConflictField(value: string): string {
