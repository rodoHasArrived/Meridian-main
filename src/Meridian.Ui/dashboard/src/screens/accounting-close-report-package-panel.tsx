import { BookCheck, CheckCircle2, LockKeyhole, Paperclip, RefreshCcw, X } from "lucide-react";
...
import type { AccountingCloseReportPackageViewModel, AccountingCloseWorkflowActionId } from "@/screens/accounting-screen.view-model";
        ...
        <CardHeader>
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.35fr)]">
            ...
            <div className="grid gap-2 text-sm">
              <AccountingCloseValue label="Fund" value={view.fundLabel} />
              <AccountingCloseValue label="Period lock" value={view.lockLabel} />
            </div>
          </div>
        </CardHeader>
