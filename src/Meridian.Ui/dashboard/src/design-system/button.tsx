 ...
 * `"icon"` (36x36 px square, no horizontal padding - use for icon-only buttons).
 *
...
export interface DesignSystemButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /** `"sm"` - compact (32 px min-height). `"default"` - standard (36 px). `"lg"` - full-width CTA or hero action (44 px). `"icon"` - square 36x36 px, no padding, for icon-only buttons. */
