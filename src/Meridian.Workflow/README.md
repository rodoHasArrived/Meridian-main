...
Physical bounded-context module project for workflow definitions, operator actions, presets, continuity paths, and process ownership conformance.
...
- `src/Meridian.Workflow` - registered source module root.
