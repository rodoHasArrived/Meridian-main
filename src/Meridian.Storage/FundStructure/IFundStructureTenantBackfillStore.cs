...
public sealed record FundStructureTenantBackfillRow(
    ...
    IReadOnlyList<Guid> Parents, IReadOnlyList<Guid> Children, JsonElement RetainedRow, bool IsInferred = false);
...
{
    /// <summary>Reads a committed receipt without opening source connections or mutation locks.</summary>
    Task<FundStructureTenantBackfillReceipt?> FindReceiptAsync(Guid runId, CancellationToken ct = default);
