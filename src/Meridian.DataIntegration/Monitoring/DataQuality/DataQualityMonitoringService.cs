...
public sealed class DataQualityMonitoringService : IAsyncDisposable
{
    ...
    public DataQualityMonitoringService(DataQualityMonitoringConfig? config = null, IEventMetrics? eventMetrics = null)
    {
        ...
        _eventMetrics = eventMetrics ?? NoopEventMetrics.Instance;
    ...
    private sealed class NoopEventMetrics : IEventMetrics
    {
        public static readonly NoopEventMetrics Instance = new();

        private NoopEventMetrics()
        {
        }
