...
public static class DepthBufferSelfTests
{
    ...
    private static void Test_InsertUpdateDelete()
    {
        ...
        collector.OnDepth(new MarketDepthUpdate(ts, sym, 0, DepthOperation.Insert, OrderBookSide.Bid, 100, 10));
        ...
        collector.OnDepth(new MarketDepthUpdate(ts, sym, 0, DepthOperation.Insert, OrderBookSide.Ask, 101, 12));
        ...
        collector.OnDepth(new MarketDepthUpdate(ts, sym, 0, DepthOperation.Update, OrderBookSide.Bid, 100, 20));
        ...
        collector.OnDepth(new MarketDepthUpdate(ts, sym, 0, DepthOperation.Delete, OrderBookSide.Ask, 0, 0));
    ...
    private static void Test_GapMarksStale()
    {
        ...
        collector.OnDepth(new MarketDepthUpdate(ts, sym, 0, DepthOperation.Update, OrderBookSide.Bid, 100, 10));
