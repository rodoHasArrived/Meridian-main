...
public static partial class WorkstationEndpoints
{
    private static void MapProviderIntegrationEndpoints(RouteGroupBuilder group, JsonSerializerOptions jsonOptions)
    {
        ...
        group.MapGet(WorkstationSubroute(UiApiRoutes.WorkstationProviderIntegrationIdentityResolution), async (
            string connectionId,
            int? recentRunLimit,
            HttpContext context) =>
        {
            ...
            var service = context.RequestServices.GetService<ProviderIntegrationIdentityResolutionPreviewService>();
            if (service is null)
            {
                return Results.Problem(
                    "Provider integration identity resolution preview service is not registered.",
                    statusCode: StatusCodes.Status501NotImplemented);
            }
        ...
        .WithName("PreviewWorkstationProviderIntegrationIdentityResolution")
        .Produces<ProviderIntegrationStagingIdentityResolutionPreviewDto>(StatusCodes.Status200OK)
        .Produces(StatusCodes.Status400BadRequest)
        .Produces(StatusCodes.Status403Forbidden)
        .Produces(StatusCodes.Status404NotFound)
        .Produces(StatusCodes.Status501NotImplemented)
        ...
        group.MapGet(WorkstationSubroute(UiApiRoutes.WorkstationProviderIntegrationPromotionReadiness), async (
            string connectionId,
            int? recentRunLimit,
            HttpContext context) =>
        {
            ...
            var service = context.RequestServices.GetService<ProviderIntegrationPromotionReadinessService>();
            if (service is null)
            {
                return Results.Problem(
                    "Provider integration promotion readiness service is not registered.",
                    statusCode: StatusCodes.Status501NotImplemented);
            }
        ...
        .WithName("PreviewWorkstationProviderIntegrationPromotionReadiness")
        .Produces<ProviderIntegrationPromotionReadinessPreviewDto>(StatusCodes.Status200OK)
        .Produces(StatusCodes.Status400BadRequest)
        .Produces(StatusCodes.Status403Forbidden)
        .Produces(StatusCodes.Status404NotFound)
        .Produces(StatusCodes.Status501NotImplemented)
