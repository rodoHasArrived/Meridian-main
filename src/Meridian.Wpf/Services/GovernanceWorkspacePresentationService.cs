...
internal static class GovernanceWorkspacePresentationService
{
    ...
    internal static GovernanceLaneSummaries BuildLaneSummaries(
        FundProfileDetail? profile,
        FundOperationsWorkspaceDto? workspace,
        ...
        int unreadAlerts)
    {
        ...
        {
            return new GovernanceLaneSummaries(
                Accounting: new GovernanceLaneSummary("Locked", "Select a fund-linked context to unlock accounting review."),
                Reconciliation: new GovernanceLaneSummary(workflow?.StatusLabel ?? "Locked", workflow?.StatusDetail ?? "Select a fund-linked context to unlock reconciliation review."),
                Reporting: new GovernanceLaneSummary("Locked", "Select a fund-linked context to unlock reporting review."),
                Audit: new GovernanceLaneSummary("Locked", "Select a fund-linked context to unlock audit review."));
        }
        ...
        return new GovernanceLaneSummaries(
            Accounting: new GovernanceLaneSummary(accountingSummary, accountingDetail),
            Reconciliation: new GovernanceLaneSummary(reconciliationSummary, reconciliationDetail),
            Reporting: new GovernanceLaneSummary(reportingSummary, reportingDetail),
            Audit: new GovernanceLaneSummary(auditSummary, auditDetail));
    }
    ...
    internal sealed record GovernanceLaneSummary(string Summary, string Detail);

    internal sealed record GovernanceLaneSummaries(
        GovernanceLaneSummary Accounting,
        GovernanceLaneSummary Reconciliation,
        GovernanceLaneSummary Reporting,
        GovernanceLaneSummary Audit);
