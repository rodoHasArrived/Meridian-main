...
public sealed class MainPageNavigationSectionViewModel
{
    public MainPageNavigationSectionViewModel(
        ...
        ReadOnlyObservableCollection<RecentPageEntry> recentPages,
        ReadOnlyObservableCollection<WorkspaceTileItem> workspaceTiles,
...
public sealed class MainPageWorkflowSectionViewModel
{
