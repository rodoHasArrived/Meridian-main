...
`AdminMaintenance` includes a view-model-owned cleanup readiness card, preview command, inline confirmation, and execute gating so destructive cleanup actions stay disabled until a staged preview has files.
