...
public static partial class ShellNavigationCatalog
{
    ...
    [
        ...
        Page<DashboardPage>("ReportRunStatus", "Report run status", "Review report run manifests, approval gates, retry audits, and dataset lineage completeness.", "reporting", "Report Packs", "\uE9D9", 15, ShellNavigationVisibilityTier.Primary, ["report status", "approval", "lineage", "audit", "schedule"], ["FundReportPack", "Dashboard", "FundAuditTrail"]),
