...
public static partial class ShellNavigationCatalog
{
    ...
    [
        ...
        Page<FundStructureSetupPage>("FundStructureSetup", "Entity setup", "Create fund-structure entities, ownership links, and account handoff drafts.", "accounting", "Fund Ops", "\uE8EF", 5, ShellNavigationVisibilityTier.Primary, ["entity setup", "fund structure", "onboarding", "ownership"], ["FundLedger", "FundAccounts"], ["EntitySetup"]),
        Page<FundLedgerPage>("FundLedger", "Fund operations", "Review journal, account, and accounting readiness in one view.", "accounting", "Fund Ops", "\uE82D", 10, ShellNavigationVisibilityTier.Primary, ["fund ledger", "journal", "operations", "continuity", "close readiness"], ["FundAccounts", "FundTrialBalance", "FundAuditTrail", "FundStructureSetup"], ["FundOperations", "OperationsContinuity", "OperationsClose"]),
        ...
        Page<FundLedgerPage>("FundAuditTrail", "Fund audit trail", "Inspect approvals, audit references, and accounting history.", "accounting", "Fund Ops", "\uE8D7", 80, ShellNavigationVisibilityTier.Secondary, ["audit", "approvals", "evidence"], ["FundLedger", "FundReconciliation"], ["EvidenceWorkbench"])
    ];

    private static readonly ShellPageDescriptor[] ReportingPages =
    [
        Page<ReportingWorkspaceShellPage>("ReportingShell", "Reporting Workspace", "Prepare report packs, dashboards, analysis exports, and export presets.", "reporting", "Launchpad", "\uE8A5", 0, ShellNavigationVisibilityTier.Primary, ["reporting", "reports", "workspace", "export"], ["FundReportPack", "ReportRunStatus", "Dashboard", "AnalysisExport", "ExportPresets"]),
        Page<FundLedgerPage>("FundReportPack", "Fund report pack", "Preview report packs and downstream handoff readiness.", "reporting", "Report Packs", "\uE8A5", 10, ShellNavigationVisibilityTier.Primary, ["report pack", "reporting", "board pack"], ["ReportRunStatus", "FundCashFinancing", "FundAuditTrail", "FundTrialBalance"]),
        Page<DashboardPage>("ReportRunStatus", "Report run status", "Review run manifests, approval gates, retry audits, and dataset lineage.", "reporting", "Report Packs", "\uE9D9", 15, ShellNavigationVisibilityTier.Primary, ["report status", "approval", "lineage", "audit", "schedule"], ["FundReportPack", "Dashboard", "FundAuditTrail"]),
