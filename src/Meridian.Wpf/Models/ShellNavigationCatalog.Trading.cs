...
public static partial class ShellNavigationCatalog
{
    ...
    [
        Page<TradingWorkspaceShellPage>("TradingShell", "Trading Workspace", "Monitor markets, review orders, and track risk across active runs.", "trading", "Desk", "\uE945", 0, ShellNavigationVisibilityTier.Primary, ["trading", "home", "workspace", "monitor"], ["RunPortfolio", "PositionBlotter", "RunRisk", "FundPortfolio", "GovernanceShell"], ["TradingWorkspace"]),
