...
public static partial class ShellNavigationCatalog
{
    ...
    [
        Page<ResearchWorkspaceShellPage>("ResearchShell", "Research Workspace", "Market briefing home with pinned insights, watchlists, run studio context, and promotion rails.", "research", "Launchpad", "\uEC35", 0, ShellNavigationVisibilityTier.Primary, ["research", "workspace", "studio", "launchpad", "briefing"], ["StrategyRuns", "Backtest", "RunPortfolio", "TradingShell"], ["ResearchWorkspace"]),
