...
public static partial class ShellNavigationCatalog
{
    ...
    [
        ...
        Page<BacktestPage>("Backtest", "Backtest", "Configure simulation inputs and launch backtest runs.", "strategy", "Studio", "\uEC35", 10, ShellNavigationVisibilityTier.Primary, ["simulation", "backtest", "configure", "scenario"], ["StrategyRuns", "RunDetail", "RunPortfolio", "LeanIntegration", "LiveData", "PortfolioImport"], ["BacktestStudio"]),
        ...
        Page<LeanIntegrationPage>("LeanIntegration", "Lean integration", "Configure Lean connectivity and review handoff status.", "strategy", "Analysis", "\uE71B", 90, ShellNavigationVisibilityTier.Overflow, ["lean", "integration", "configure", "engine"], ["Backtest", "StrategyRuns", "LiveData", "PortfolioImport"]),
