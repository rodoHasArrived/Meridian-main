...
public static partial class ShellNavigationCatalog
{
    ...
    [
        Page<ResearchWorkspaceShellPage>("ResearchShell", "Research Home", "Monitor research priorities, review watchlists, and open run workflows.", "research", "Launchpad", "\uEC35", 0, ShellNavigationVisibilityTier.Primary, ["research", "home", "workspace", "monitor"], ["StrategyRuns", "Backtest", "RunPortfolio", "TradingShell"], ["ResearchWorkspace"]),
        ...
        Page<DashboardPage>("Dashboard", "Portfolio operations", "Monitor holdings, quality exceptions, maturities, and export readiness.", "research", "Operations", "\uE71D", 60, ShellNavigationVisibilityTier.Secondary, ["overview", "portfolio", "holdings", "quality"], ["ResearchShell", "DataQuality", "SecurityMaster"], hideFromDefaultPalette: true),
