...
public static partial class ShellNavigationCatalog
{
    ...
    [
        ...
        Page<DashboardPage>("Dashboard", "Dashboard", "Legacy overview to monitor status and review key alerts.", "research", "Legacy", "\uE71D", 60, ShellNavigationVisibilityTier.Secondary, ["overview", "status", "alerts"], ["ResearchShell", "NotificationCenter"], hideFromDefaultPalette: true),
