...
[RequiresCredential("ROBINHOOD_ACCESS_TOKEN",
    EnvironmentVariables = new[] { "ROBINHOOD_ACCESS_TOKEN", "ROBINHOOD__ACCESSTOKEN" },
    DisplayName = "Access Token",
    Description = "Robinhood personal access token for the unofficial historical endpoint")]
