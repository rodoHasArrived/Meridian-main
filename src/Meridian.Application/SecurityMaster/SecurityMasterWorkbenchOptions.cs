...
public sealed class SecurityMasterWorkbenchOptions
{
    ...
    /// <summary>
    /// When true, the DIRECT term-amendment endpoints — the generic amend route and the bespoke
    /// preferred/convertible equity PATCH routes — are refused with guidance to use the governed
