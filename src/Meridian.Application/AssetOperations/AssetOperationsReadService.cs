...
namespace Meridian.Application.AssetOperations;
...
public sealed class AssetOperationsReadService : IAssetOperationsQueryService
{
    ...
    private readonly SecurityMaster.ISecurityMasterQueryService? _securityMasterQueryService;
    ...
    public AssetOperationsReadService(
        ...
        SecurityMaster.ISecurityMasterQueryService? securityMasterQueryService = null,
