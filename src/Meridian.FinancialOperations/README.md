...
- `Reconciliation/Connectors/` - custodian/broker statement connector library (ADR-018):
  ...
  (content-sniffed, parsed forward-only with a shared 100,000-record bound, and mapped directly to
  canonical records); `StatementImportService` preview/commit
